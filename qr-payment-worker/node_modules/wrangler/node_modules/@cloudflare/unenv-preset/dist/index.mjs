...
function getInspectorOverrides({
  ...
  const enabledByFlag = compatibilityFlags.includes("enable_nodejs_inspector_module") && compatibilityFlags.includes("experimental");
...
function getSqliteOverrides({
  ...
  const enabledByFlag = compatibilityFlags.includes("enable_nodejs_sqlite_module") && compatibilityFlags.includes("experimental");
  const enabled = enabledByFlag && !disabledByFlag;
  return enabled ? {
