...
public class TransferServiceTests {
    ...
    private static TransferRequest createTransferRequest(Long from, Long to, BigDecimal amount) {
        ...
        request.setFromWallet(from);
        request.setToWallet(to);
    ...
    // ========== Successful Transfer Tests ==========
        ...
        void testTransfer_Success() {
            ...
            assertEquals(1L, response.getFromWallet());
            assertEquals(2L, response.getToWallet());
            assertEquals(BigDecimal.valueOf(50.00), response.getTransferAmount());
            assertNotNull(response.getTransferDate());
        ...
        void testTransfer_ExactBalance() {
            ...
            assertEquals(BigDecimal.valueOf(100.00), response.getTransferAmount());
        ...
        void testTransfer_HighPrecisionAmount() {
            ...
            assertEquals(preciseAmount, response.getTransferAmount());
        ...
        void testTransfer_LargeAmount() {
            ...
            assertEquals(largeAmount, response.getTransferAmount());
        ...
        void testTransfer_OneCent() {
            ...
            assertEquals(oneCent, response.getTransferAmount());
        ...
        void testTransfer_SameWallet_IsAllowed() {
            ...
            assertEquals(1L, response.getFromWallet());
            assertEquals(1L, response.getToWallet());
        }
